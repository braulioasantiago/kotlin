...
private fun processCLib(
    ...
    val configuration = InteropConfiguration(
            ...
            cinteropHeaderMode = cinteropArguments.cinteropHeaderMode,
    )
    ...
    val nativeOutputPath: String? = if (cinteropArguments.cinteropHeaderMode) null else {
        when (flavor) {
            KotlinPlatform.JVM -> {
    ...
    val compiledFiles = if (cinteropArguments.cinteropHeaderMode) emptyList() else {
...
internal fun buildNativeLibrary(
    ...
    val compilation = CompilationImpl(
            ...
            language = language,
            cinteropHeaderMode = arguments.cinteropHeaderMode
    )
